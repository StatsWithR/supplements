...
$$ \textsf{Beta}(p; \alpha, \beta) = \frac{\Gamma(\alpha)\Gamma(\beta)}{\Gamma(\alpha + \beta)}p^{\alpha - 1}(1-p)^{\beta - 1}. $$
...
plot1 + geom_segment(aes(x = 0.5, y = 0, xend = 0.5, yend = length(p.pointMass) / length(p)), 
